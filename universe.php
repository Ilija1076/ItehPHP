...
<head>
    ...
    <title>Destinations in the Universe</title>
</head>

<body>
    <div class="jumbotron text-center">
        <div class="container">
            <h1>Destinations in the Universe</h1>
        </div>
    </div>
                        ...
                        <div class="modal-body">
                            <form action="#" method="post" id="addForm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="planet" name="planet" placeholder="Enter planet">
                                </div>
                                <div class="form-group">
